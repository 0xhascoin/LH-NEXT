...
const PostJobSuccessModal = ({ submitted, setSubmitted, job, id }) => {
                ...
                <header className="modal-card-head">
                    ...
                    <div className="modal-heading">
                        ...
                        <div className="heading-title">
                            <h2>Post Job Success</h2>
                            <p>Thank You {job?.companyName}. Your job has been posted successfully</p>
                            <br />
                            <a href={`/job/${id}`} className="my-3 has-text-primary">Job Link</a>
                        </div>
                    </div>
